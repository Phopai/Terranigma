...
blob_img = pygame.image.load('img/Whispe.png')
platform_x_img = pygame.image.load('img/Woodx.png')
platform_y_img = pygame.image.load('img/Woody.png')
lava_img = pygame.image.load('img/Spike.png')
...
load_img = pygame.image.load('img/buttonrestart.png')
